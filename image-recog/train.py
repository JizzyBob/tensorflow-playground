...
By default, this script will log summaries to c:/tf_images/retrain_logs directory

Visualize the summaries with this command:

tensorboard --logdir c:/tf_images/retrain_logs
...
python retrain.py (... other args as before ...) \
    --saved_model_dir=c:/tf_images/saved_models/$(date +%s)/
tensorflow_model_server --port=9000 --model_name=my_image_classifier \
    --model_base_path=c:/tf_images/saved_models/
```
"""
...
CHECKPOINT_NAME = 'c:/tf_images/_retrain_checkpoint'
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='c:/tf_images/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='c:/tf_images/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='c:/tf_images/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='c:/tf_images/retrain_logs',
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='c:/tf_images/bottleneck',
